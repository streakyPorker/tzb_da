use tzbv1;
drop table if exists fruit_veg;
create table fruit_veg
(
    id                                INT primary key,
...
insert into fruit_veg
select *
from origin_data
where prod_category_english_nn like 'fruit and fruit product'
   or prod_category_english_nn like 'vegetable and vegetable product';
